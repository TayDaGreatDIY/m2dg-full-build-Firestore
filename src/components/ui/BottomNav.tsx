...
import { Home, Newspaper, Map, Trophy, MessageSquare, ShieldCheck, Bell, ShoppingBag, BrainCircuit } from "lucide-react";
...
const navItems = [
  ...
  { href: "/motivational-mindset", icon: BrainCircuit, label: "Mindset" },
